...
class Log:
    ...
    # packet corrupted by the channel, in case of realistic propagation
    LOG_CORRUPTED_BY_CHANNEL = Packet.PKT_CORRUPTED_BY_CHANNEL
    # packet has just been generated
    LOG_GENERATED = LOG_CORRUPTED_BY_CHANNEL + 1
